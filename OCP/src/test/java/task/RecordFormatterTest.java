...
public class RecordFormatterTest {
    ...
    public void formatAddress() {
        ...
        aRec.setIndex("61000");
        String fmt = new AddressRecordFormatter().format(aRec);
    ...
    public void formatBirthday() {
        ...
        bRec.setMonth(11);
        bRec.setDay(27);
        String fmt = new BirthdayRecordFormatter().format(bRec);
    ...
    public void formatVisa() {
        ...
        String fmt = new VisaRecordFormatter().format(vRec);
    ...
    public void formatWorkload() {
        ...
        String fmt = new WorkloadRecordFormatter().format(wRec);
    ...
    public void formatSkills() {
        ...
        String fmt = new SkillsRecordFormatter().format(sRec);
    ...
    public void formatFeedback() {
        ...
        String fmt = new FeedbackRecordFormatter().format(fRec);
